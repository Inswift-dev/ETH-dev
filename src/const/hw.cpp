...
EthConfig ethConfigs[] = {
    ...
    {.addr = 1, .pwrPin = 5, .mdcPin = 23, .mdiPin = 18, .phyType = ETH_PHY_TLK110, .clkMode = ETH_CLOCK_GPIO0_IN},  //  3 inswift
};
...
ZbConfig zbConfigs[] = {
    ...
    {.txPin = 17, .rxPin = 13, .rstPin = 15, .bslPin = 33}, // 8 inswift
};
...
MistConfig mistConfigs[] = {
    ...
    {.btnPin = 34, .btnPlr = 1, .uartSelPin = -1, .uartSelPlr = 0, .ledModePin = 2, .ledModePlr = 0, .ledPwrPin = 14, .ledPwrPlr = 0}, // 5 inswift
    // {.btnPin = 34, .btnPlr = 1, .uartSelPin = -1, .uartSelPlr = 0, .ledModePin = 2, .ledModePlr = 0, .ledPwrPin = 14, .ledPwrPlr = 0, .ledMode2Pin = 4, .ledMode2Plr = 0}, // 5 inswift
};
